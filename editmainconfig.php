...
?>
    ...
    <fieldset>
        ...
        <span class="title"><?php echo __('Map width:', 'freeaustralia-html5-map'); ?> </span><input class="span2" type="text" name="options[mapWidth]" value="<?php echo intval($options[$map_id]['mapWidth']); ?>" />
        <span class="tipsy-q" original-title="<?php esc_attr_e('The width of the map', 'freeaustralia-html5-map'); ?>">[?]</span>
        <div class="clear"></div>

        <span class="title"><?php echo __('Map height:', 'freeaustralia-html5-map'); ?> </span><input class="span2" type="text" name="options[mapHeight]" value="<?php echo intval($options[$map_id]['mapHeight']); ?>" />
...
<hr>
        ...
        <span class="tipsy-q" original-title="<?php esc_attr_e('The color of borders on the map', 'freeaustralia-html5-map'); ?>">[?]</span><div class="fm-colorpicker"></div>
        <div class="clear"></div>
        ...
        <span class="tipsy-q" original-title="<?php esc_attr_e('The color of borders on the map while mouse is over this region', 'freeaustralia-html5-map'); ?>">[?]</span><div class="fm-colorpicker"></div>
        <div class="clear"></div>
    ...
    <fieldset>
        ...
        <label><?php echo __('Custom HTML container:', 'freeaustralia-html5-map') ?> <input type="radio" name="options[statesInfoArea]" value="custom" <?php echo $options[$map_id]['statesInfoArea'] == 'custom'?'checked="checked"':''?> /></label>
        ...
        <label>
            <span class="title"><?php echo __('Use ajax to load info:', 'freeaustralia-html5-map'); ?></span>
            <input type="checkbox" name="options[statesInfoUseAjax]" <?php echo $options[$map_id]['statesInfoUseAjax']?'checked="checked"':''?> />
        </label>&nbsp;&nbsp;&nbsp;&nbsp;
        <span class="tipsy-q" original-title="<?php esc_attr_e('Using ajax can decrease page load speed in cases when many states or points contains additional info', 'freeaustralia-html5-map'); ?>">[?]</span>
        
        <div class="clear" style="margin-bottom: 10px"></div>
        <div style="float: left; width: 50%;">
            <label>
            <span class="title"><?php echo __('Scroll to info area on click:', 'freeaustralia-html5-map')?></span>
            ...
            <span class="tipsy-q" original-title="<?php esc_attr_e('Automatically scroll to info area on click', 'freeaustralia-html5-map'); ?>">[?]</span>
        </div>
        ...
        <div style="float: left; width: 50%; display: none" id="customInfoContainerBlock">
            <span class="title"><?php echo __('CSS selector for container:', 'freeaustralia-html5-map'); ?> </span><input type="text" name="options[customInfoContainer]" value="<?php echo $options[$map_id]['customInfoContainer']; ?>">
            <span class="tipsy-q" original-title="<?php esc_attr_e('Specify valid CSS selector for container that will be used to display additional information', 'freeaustralia-html5-map'); ?>">[?]</span>
        </div>
        <div class="clear"></div>
        <div id="action-info">
    ...
    <fieldset class="font-sizes">
        ...
        <div style="float: left; width: 50%">
            ...
            <span class="tipsy-q" original-title="<?php esc_attr_e('The color of names on the map', 'freeaustralia-html5-map'); ?>">[?]</span><div class="fm-colorpicker"></div><br />
            ...
            <span class="tipsy-q" original-title="<?php esc_attr_e('The color of names on the map while mouse is over', 'freeaustralia-html5-map'); ?>">[?]</span><div class="fm-colorpicker"></div><br />
        ...
        <div style="float: left; width: 50%">
            ...
            <span class="tipsy-q" original-title="<?php esc_attr_e('The color of names on the tooltip', 'freeaustralia-html5-map'); ?>">[?]</span><div class="fm-colorpicker"></div><br />
            ...
            <span class="tipsy-q" original-title="<?php esc_attr_e('The color of content in the tooltip', 'freeaustralia-html5-map'); ?>">[?]</span><div class="fm-colorpicker"></div><br />
        </div>
...
?>
    <fieldset class="font-sizes">
        ...
        <span class="title"><?php echo __('Old AJAX queries:', 'freeaustralia-html5-map'); ?> </span><input type="checkbox" name="options[useAjaxUrls]" value="1" <?php echo (!$options[$map_id]['useAjaxUrls']) ?'checked':'' ?> />
        <span class="tipsy-q" original-title="<?php esc_attr_e('Enable this option if you have troubles with any other plugins', 'freeaustralia-html5-map'); ?>">[?]</span><br />
        <div class="clear" style="margin-bottom: 10px"></div>
