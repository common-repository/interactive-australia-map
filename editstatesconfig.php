...
if ($sId && !isset($states['st' . $sId])) {
    freeaustralia_html5map_plugin_messages(null, array(__('Unknown state id', 'freeaustralia-html5-map')));
    $sId = false;
}
...
?>
    ...
    <fieldset>
        ...
        <span class="title"><?php echo __('Name:', 'freeaustralia-html5-map'); ?> </span><input class="" type="text" name="name[<?php echo $vals['id']?>]" value="<?php echo esc_attr($vals['name']) ?>" />
        ...
        <span class="title"><?php echo __('Shortname:', 'freeaustralia-html5-map'); ?> </span><input class="" type="text" name="shortname[<?php echo $vals['id']?>]" value="<?php echo esc_attr($vals['shortname']) ?>" />
        ...
        <div style="<?php echo $style_input; ?>" id="stateURL<?php echo $vals['id']?>">
            <span class="title"><?php echo __('URL:', 'freeaustralia-html5-map'); ?> </span><input style="width: 240px;" class="" type="text" name="URL[<?php echo $vals['id']?>]" id="URL<?php echo $vals['id']?>" value="<?php echo esc_attr($vals['link']) ?>" />
        ...
        <br />
        <span class="title"><?php echo __('Area color:', 'freeaustralia-html5-map'); ?> </span><input class="color colorSimple" type="text" name="color[<?php echo $vals['id']?>]" value="<?php echo esc_attr($vals['color_map']) ?>" style="background-color: #<?php echo $vals['color_map']?>"  />
        <span class="tipsy-q" original-title='<?php esc_attr_e('The color of an area.', 'freeaustralia-html5-map'); ?>'>[?]</span><div class="fm-colorpicker"></div>
        ...
        <br />
        <span class="title"><?php echo __('Area hover color:', 'freeaustralia-html5-map'); ?> </span><input class="color colorOver" type="text" name="color_[<?php echo $vals['id']?>]" value="<?php echo esc_attr($vals['color_map_over']) ?>" style="background-color: #<?php echo $vals['color_map_over']?>"  />
        <span class="tipsy-q" original-title='<?php echo __('The color of an area when the mouse cursor is over it.', 'freeaustralia-html5-map'); ?>'>[?]</span><div class="fm-colorpicker"></div>
        ...
        <label style="margin-left:20px; cursor: default"><span style="color: #666">ID: <?php echo esc_html('st'.$sId) ?> </span><span class="tipsy-q" original-title="<?php esc_attr_e('Use this ID when interacting with the map via API', 'freeaustralia-html5-map'); ?>">[?]</span></label>
        <br />
